...
void do_line(int kp, int kd, int spd) {
  ...
  v_phai = middle(spd - pd_change, 0, 255);
...
void display_adc() {
  lcd.setCursor(0, 1);   lcd.print(ng_adc[0]);
  lcd.setCursor(4, 1);   lcd.print(ng_adc[1]);
  lcd.setCursor(8, 1);   lcd.print(ng_adc[2]);
  lcd.setCursor(12, 1);  lcd.print(ng_adc[3]);
}
